...
print("C=Capture  T=Toggle auto-capture  Q=Quit")
print(">>> CLICK THE WINDOW BEFORE PRESSING KEYS <<<")

try:
    cv2.namedWindow("Lane Data Collection", cv2.WINDOW_AUTOSIZE)
    ...
    while True:
        ...
        color = (0, 200, 0) if auto_mode else (0, 180, 255)
        cv2.putText(display, f"W/S/A/D=Drive  Space=Stop  C=Capture  T=Auto  Q=Quit",
                    (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
        cv2.putText(display, f"{mode_label} | Captured: {count}",
